        ...
        <ul class="flex gap-4 md:gap-8">
          ...
          >
            <address class="flex items-center gap-2 not-italic">
              <img
                :src="author.picture"
                :alt="`Profil picture of ${author.name}`"
              ...
              <div class="text-sm">
                ...
                <div class="mt-1">
                  <NuxtLink
                    ...
                    target="_blank"
                    class="text-gray-500 dark:text-gray-400 hover:text-gray-800 hover:dark:text-gray-200 leading-none font-medium transition ease-in"
                  >
                    @{{ author.twitter }}
                  </NuxtLink>
                </div>
